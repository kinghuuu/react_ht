...
import ProgramConsumeEdit from './module/programConsumeEdit';

class ProgramConsumeModule extends Component {
    constructor(props) {
        super(props);
        this.state = {
            editVisable: false,
        ...
        this.columns = [
            ...
            { title: '调用方模块名称', dataIndex: 'providerProgram', width: '20%' },
            { title: '提供方应用系统', dataIndex: 'programCallerSystem', width: '20%' },
            { title: '提供方模块名称', dataIndex: 'callerProgram', width: '20%' },
            {
                        ...
                        <a onClick={showModuleDetails.bind(this, record)} style={{ color: 'green' }} >详情</a>
                        {
                            isLeader ? null : (
                                <Fragment>
                                    ...
                                    <Divider type='vertical' />
                                    <a
                                        onClick={props.showDeleteConfirm.bind(this, { record, moduleKey: 'providerProgram' })}
                                        style={{ color: 'red' }}
                                    >删除</a>
                                </Fragment>
                            )
...
export default connect(mapStateToProps)(ProgramConsumeModule);