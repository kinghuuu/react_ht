...
import ProcessEdit from './module/processEdit';
...
class ProcessModule extends Component {
    constructor(props) {
        ...
        this.columns = [
            ...
            { title: '进程名称', dataIndex: 'processName' },
            { title: '端口', dataIndex: 'port', width: '12%' },
            { title: '所属模块', dataIndex: 'program', width: '20%' },
            {
                title: '是否监控', dataIndex: 'isMonitor', width: '10%', render: value => {
                    return value === '01' ? '是' : '否';
                }
            },
            {
                    ...
                    return (<Fragment>
                        ...
                        {isLeader ? null : (
                            <Fragment>
                                ...
                                <Divider type='vertical' />
                                <a
                                    onClick={props.showDeleteConfirm.bind(this, { record, moduleKey: 'processName' })}
                                    style={{ color: 'red' }}
                                >删除</a>
                            </Fragment>
                        )}
...
export default connect(mapStateToProps)(ProcessModule);