...
class ServiceConsumeOperation extends Component {
    constructor(props) {
        super(props);
    ...
    handleSearch = (e) => {
        ...
        let { providerServiceId: { value: [providerServiceId = ''] }, businessId = {} } = getFieldsValue();

        if (isShowOtherQuery) {
            selfDefineQuery = this.searchForm.getValue();
        }
        propertyValue = [
            { propId: 'providerServiceId', propValue: providerServiceId },
...
ServiceConsumeOperation = Form.create()(ServiceConsumeOperation);
export default connect(mapStateToProps)(ServiceConsumeOperation);